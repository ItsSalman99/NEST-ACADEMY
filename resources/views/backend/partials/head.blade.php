<head>
    ...
    <!-- ion Range Slider -->
    <link type="text/css" href="{{ asset('assets/backend/css/vendor-ion-rangeslider.css') }}" rel="stylesheet">
    <link type="text/css" href="{{ asset('assets/backend/css/vendor-ion-rangeslider.rtl.css') }}" rel="stylesheet">
