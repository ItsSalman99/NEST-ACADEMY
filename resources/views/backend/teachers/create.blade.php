    ...
    <div class="mdk-header-layout__content mdk-header-layout__content--fullbleed mdk-header-layout__content--scrollable page"
        ...
        <div class="page__heading border-bottom">
            <div class="container-fluid page__container d-flex align-items-center">
                <h1 class="mb-0">Add New Teacher</h1>
            </div>
        </div>
            ...
            <div class="card card-form">
                <div class="row no-gutters">
                    <div class="col-lg-4 card-body">
                        <p><strong class="headings-color">Add new Teacher</strong></p>
                        <p class="text-muted mb-0">Add a new teacher by filling up all fields.</p>
                    </div>
                    <div class="col-lg-8 card-form__body card-body">
                        ...
                        <form action="{{ route('teachers.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input name="teacher_id" type="number" class="form-control" placeholder="Teacher Id">
                            </div>
                            <div class="form-group">
